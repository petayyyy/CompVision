...
namespace Lab_4_CompVision
{
    public partial class Form1 : Form
    {
        ...
        {
            InitializeComponent();
            list_sample.Add(new Mat(@"C:/Users/ilyah/CompVision/Lab_4/Data/Forward.png"));
            list_sample.Add(new Mat(@"C:/Users/ilyah/CompVision/Lab_4/Data/Around.png"));
            list_sample.Add(new Mat(@"C:/Users/ilyah/CompVision/Lab_4/Data/Left.png"));
            list_sample.Add(new Mat(@"C:/Users/ilyah/CompVision/Lab_4/Data/Brick.png"));
            list_sample.Add(new Mat(@"C:/Users/ilyah/CompVision/Lab_4/Data/Stop.png"));
        }
        ...
        public void work()
        {
            ...
            //{
                ...
                if (is_mask)
                {
                    // Mask
                    red_flow = new Mat();
                    Cv2.InRange(hsv_flow, new Scalar(mask_hsv[0], mask_hsv[1], mask_hsv[2]), new Scalar(mask_hsv[3], mask_hsv[4], mask_hsv[5]), mask_flow);
                    Cv2.FindContours(mask_flow, out OpenCvSharp.Point[][] countorss, out HierarchyIndex[] hierarchyIndexess, RetrievalModes.External, ContourApproximationModes.ApproxSimple);
                ...
                if (is_detect)
                {
                    ...
                    for (int i = 0; i < list_claster.Count; i++)
                    {
                        Mat mini_flow = blue_flow.Clone()[list_claster[i]];
                        
                        Cv2.Rectangle(output_flow, list_claster[i], new Scalar(0, 0, 255));
                        Cv2.PutText(output_flow, list_claster[i].ToString(), new OpenCvSharp.Point(list_claster[i].X, list_claster[i].Y), HersheyFonts.Italic, 0.5, new Scalar(255, 0, 255));
                    }
                }
                // Image to picturebox
                // input image
